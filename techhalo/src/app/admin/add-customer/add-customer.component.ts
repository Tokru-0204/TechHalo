...
// import { CustomerService } from 'src/app/services_admin/customer.service';
...
export class AddCustomerComponent_Admin implements OnInit {
  ...
  selectFile!: File;
  url: string = 'https://res.cloudinary.com/techhalo/image/upload/v1730081981/techhalo/pzjqsq33ethm4dsgxde8.jpg';
